...
export function renderSubjectsList(subjects, activeId) {
  ...
  subjects.forEach(sub => {
    ...
    item.innerHTML = `
      ...
      <button class="delete-subject-btn text-brand-muted hover:text-brand-error transition-opacity duration-150 opacity-0 group-hover:opacity-100 p-0.5 rounded" data-action="delete-subject" data-id="${sub.id}" title="Eliminar">
